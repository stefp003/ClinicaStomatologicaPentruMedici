...
namespace ClinicaStomatologicaPentruMedici.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            Data.ClinicaStomatologicaPentruMediciContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                // Save the name in the Doctor entity
